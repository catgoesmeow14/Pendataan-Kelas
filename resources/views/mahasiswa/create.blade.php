...
<div class="d-sm-flex flex-wrap justify-content-between align-items-center pb-2">
    <h2 class="h3 py-2 me-2 w-100 text-sm-center">Tambah Data Mahasiswa</h2>
</div>
...
<form action="{{route('mahasiswas.store')}}" method="POST">
    ...
    <div class="mb-3 pb-2">
        ...
        <input name="nama" class="form-control @error('nama') is-invalid @enderror" type="text" id="nama"
            value="{{old('nama')}}" placeholder="ex:Vidya Cantik">
    ...
    <div class="mb-3 pb-2">
        ...
        <input name="nim" class="form-control @error('nim') is-invalid @enderror" type="text" id="nim"
            value="{{old('nim')}}" placeholder="ex:1905551xxx">
    ...
    <div class="mb-3 pb-2">
        ...
        <input name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" type="text" id="no_hp"
            value="{{old('no_hp')}}" placeholder="ex:081234567890">
